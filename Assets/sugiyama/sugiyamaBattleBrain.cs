...
// // 自分でAIを実装する場合 -------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/sugiyamaBattleBrain")]
// public class sugiyamaBattleBrain : BattleBrain {
...
// ニューラルネットワークのAIを使う場合 --------------------------------------------------
[CreateAssetMenu(menuName = "BattleBrain/sugiyamaBattleBrain")]
public class sugiyamaBattleBrain : NNBattleBrain
{
    /// <summary>
    /// 使用するセンサーの設定.
    /// </summary>
    ...
    /// `sugiyamaBattleBrain`ではInspectorのSelected Inputsで選択したセンサーの値を使う.
    /// </summary>
    public override double[] GetAction(List<double> observation)
    {
...
// // Q学習のAIを使う場合 ----------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/sugiyamaBattleBrain")]
// public class sugiyamaBattleBrain : QBattleBrain
// {
//     /// <summary>
